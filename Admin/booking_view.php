		...
		if($booking_data_row)
		{
			...
			while($fetch=$booking_data_row->fetch_array())
			{
				...
				<tr>
					...
					<td><?php echo $fetch['pick_address']; ?></td>
					<td><?php echo $fetch['end_address']; ?></td>
					<td><?php echo $fetch['date']; ?></td>
					<td><?php echo $fetch['driver_name']; ?></td>
					<td><?php echo $fetch['assign_car']; ?></td>
					<td><?php echo $fetch['amount']; ?></td>
					<td><a href="booking_edit.php?edit=<?php echo $fetch[0]; ?>"><i class="fa fa-eye" aria-hidden="true"></i></a>
					<a href="booking_edit.php?edit=<?php echo $fetch[0]; ?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
